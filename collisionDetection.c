...
// remove later		distancecheck = sqrt(pow((sarr[sph * 3 + 0]-pox),2)+pow((sarr[sph * 3 + 1]-poy),2)+pow((sarr[sph * n_cols + 2]-poz),2));
...
//			}
			...
			// calculating distance to each vertex of triangle
